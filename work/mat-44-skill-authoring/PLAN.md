...
- [x] S1 (judgment): record the RED baseline evidence in DECISIONS.md
...
- [x] S2 (judgment): `skills/skill-authoring/SKILL.md` — GREEN, the
...
- [x] S3 (judgment): `skills/skill-authoring/references/testing-with-subagents.md`
...
- [x] S4 (integration): `reference/skills.md` — the composing section
...
- [x] S5 (integration): same-change docs — `docs/how-it-works/architecture.md`
...
- [x] S6 (controller): REFACTOR then close — re-run S1's two baseline
