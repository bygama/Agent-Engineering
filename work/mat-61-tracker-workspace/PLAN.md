...
- [x] 1. `judgment` — test(ae-init): new `skills/ae-init/evals/eval-05.md`
...
- [x] 2. `judgment` — docs(reference): `reference/tracker.md` gains the
...
- [x] 3. `integration` — fix(ae-init): `skills/ae-init/SKILL.md` — step 3
...
- [x] 4. `mechanical` — test(work-handoff): one checklist line in
...
- [x] 5. `mechanical` — fix(work-handoff): one line in
      ...
      tests,templates,global,examples` exits 0.
- [x] 6. `mechanical` — docs(how-it-works): one sentence in
