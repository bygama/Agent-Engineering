...
| `(five\|six\|seven\|eight\|nine\|[0-9]+) (decisions?\|ADRs?)` on living surfaces, checked against `ls docs/adrs/` | hardcoded ADR/decision counts and lists that drift when an ADR lands | README's Status said "five decisions" (ADR-001..005) while eight ADRs existed — 006/007/008 missing (MAT-103, post-1.4.1 sweep) |
